...
export default function SubjectNotes({
  ...
  const handleAutofillMock = () => {
    setChapterNo(notes.length + 1);
    
    if (subject === "Computer Science") {
      setChapterName("Database Management & SQL Commands");
    } else if (subject === "Mathematics") {
      setChapterName("Calculus Limits and Integrals");
    } else if (subject === "Science") {
      setChapterName("Chemical Bonding and Reactions");
    } else {
      setChapterName("Introduction to Literature Review");
    }
    
    // Create a tiny valid empty PDF DataUrl as default mockup
    setPdfBase64("data:application/pdf;base64,JVBERi0xLjQKMSAwIG9iago8PAovVGl0bGUgKFR1aXRpb24gTm90ZXMpCi9DcmVhdG9yIChBY2FkZW15IExlZGdlcikKPj4KZW5kb2JqCnhyZWYKMCAxCjAwMDAwMDAwMDAgNjU1MzUgZiAKdHJhaWxlcgo8PAovU2l6ZSAyCi9Sb290IDEgMCBSCj4+CnN0YXJ0eHJlZgoxMAolJUVPRgo=");
    setPdfName("chapter_revision_notes.pdf");
    setError("");
  };
        ...
        >
          <div className="flex justify-between items-center pb-2 border-b border-slate-50 dark:border-slate-850">
            ...
            <button
              ...
              className="text-[10px] font-extrabold uppercase text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 px-2.5 py-1.5 rounded-xl border border-blue-100 dark:border-blue-900/30 flex items-center gap-1 transition-all cursor-pointer"
              title="Autofill mock PDF template"
            >
